<script>
  ...
  <!-- Hero Content -->
  <div class="flex items-center justify-center px-4 py-20 w-full mx-auto relative z-10">
    <div class="z-10 text-center max-w-4xl">
      ...
      <span class="inline-block bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent text-base font-semibold font-mono">
         i swear i'm a good developer, trust me bro
      </span>

      <p class="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl font-mono mb-10">
